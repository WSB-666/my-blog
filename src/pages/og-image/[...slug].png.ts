...
import NotoSansSCBold from "@/assets/noto-sc-b.ttf";
import NotoSansSC from "@/assets/noto-sc-r.ttf";
...
const ogOptions: SatoriOptions = {
	...
	fonts: [
		...
		// 中文字体兜底（Roboto Mono 不含中文字形，缺字时 satori 按顺序回退）
		// 字体为 Noto Sans SC（OFL 协议），已按 GB2312 常用字符集裁剪
		{
